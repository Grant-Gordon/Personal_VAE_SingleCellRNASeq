...
def start_preload_workers(dataset, data_dir, batch_size, num_threads, preload_queue, chunk_queue, config):
    def worker():
        while True:
            ...
            preload_queue.put((chunk_idx, loader, time.time()- start_time))
