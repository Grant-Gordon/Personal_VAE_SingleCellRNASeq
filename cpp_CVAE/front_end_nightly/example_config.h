...
constexpr int              Training_Optimizer__beta1 = 1;
constexpr int              Training_Optimizer__beta2 = 2;
constexpr int              Training_Optimizer__epsilon = 3;
...
constexpr std::string_view Data__num_features = 999;
...
constexpr std::array<std::shared_ptr<Layer<Scalar>>, 7> layers_vector = {
    std::make_shared<LinearLayer<Scalar>>(999, 512, glorot),
    std::make_shared<RELULayer<Scalar>>(),
    std::make_shared<LinearLayer<Scalar>>(512, 128, florot),
    std::make_shared<RELULayer<Scalar>>(),
    std::make_shared<LinearLayer<Scalar>>(128, 512, glorot),
    std::make_shared<RELULayer<Scalar>>(),
    std::make_shared<LinearLayer<Scalar>>(512, 999, glorot),
};
}