...
constexpr int              Training__batch_size = 32;
constexpr float            Training__lr = 0.001;
constexpr std::string_view Training__output_dir = "/home/grantresearch/czi/Personal_VAE_SingleCellRNASeq/cpp_CVAE/JobOutputs";
constexpr std::string_view Data__data_dir = "/home/grant/research/czi/";
...
constexpr int              Data__batches_to_preload = 1;
