...
MatrixD<Scalar> RELULayer<Scalar>::forward(const MatrixD<Scalar>& input){
...
template <typename Scalar>
MatrixD<Scalar> RELULayer<Scalar>::backward(const MatrixD<Scalar>& grad_output ){
    MatrixD<Scalar> grad_input = grad_output;
